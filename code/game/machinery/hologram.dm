...
/obj/machinery/holopad/Hear(message, atom/movable/speaker, datum/chatmessage/message_image, datum/language/message_language, raw_message, radio_freq, list/spans, list/message_mods = list())
	. = ..()
	...
	for(var/I in holo_calls)
		...
		if(HC.connected_holopad == src && speaker != HC.hologram)
			...
			if(HC.user.client)
				message_image.show_chat_message(HC.user.client, HC.user.get_chatmessage_flags(speaker, message_language, message_mods))
