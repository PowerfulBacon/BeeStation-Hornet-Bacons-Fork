...
/turf/open/floor/mineral/plasma/proc/PlasmaBurn(temperature)
	make_plating()
	create_atmos_populator().with_gas(GAS_PLASMA, 20).at_temperature(temperature)
...
APPLY_AIRLESS_ATMOS(/turf/open/floor/mineral/titanium/airless)

/turf/open/floor/mineral/titanium/yellow
	icon_state = "titanium_yellow"
	floor_tile = /obj/item/stack/tile/mineral/titanium/yellow

APPLY_AIRLESS_ATMOS(/turf/open/floor/mineral/titanium/yellow/airless)

/turf/open/floor/mineral/titanium/blue
	icon_state = "titanium_blue"
	floor_tile = /obj/item/stack/tile/mineral/titanium/blue

APPLY_AIRLESS_ATMOS(/turf/open/floor/mineral/titanium/blue/airless)

/turf/open/floor/mineral/titanium/white
	icon_state = "titanium_white"
	floor_tile = /obj/item/stack/tile/mineral/titanium/white

APPLY_AIRLESS_ATMOS(/turf/open/floor/mineral/titanium/white/airless)

/turf/open/floor/mineral/titanium/purple
	icon_state = "titanium_purple"
	floor_tile = /obj/item/stack/tile/mineral/titanium/purple

APPLY_AIRLESS_ATMOS(/turf/open/floor/mineral/titanium/purple/airless)
...
APPLY_AIRLESS_ATMOS(/turf/open/floor/mineral/titanium/tiled/airless)

/turf/open/floor/mineral/titanium/tiled/yellow
	icon_state = "titanium_alt_yellow"
	floor_tile = /obj/item/stack/tile/mineral/titanium/tiled/yellow

APPLY_AIRLESS_ATMOS(/turf/open/floor/mineral/titanium/tiled/yellow/airless)
...
APPLY_AIRLESS_ATMOS(/turf/open/floor/mineral/titanium/tiled/blue/airless)

/turf/open/floor/mineral/titanium/tiled/white
	icon_state = "titanium_alt_white"
	floor_tile = /obj/item/stack/tile/mineral/titanium/tiled/white

APPLY_AIRLESS_ATMOS(/turf/open/floor/mineral/titanium/tiled/white/airless)
...
APPLY_AIRLESS_ATMOS(/turf/open/floor/mineral/titanium/tiled/purple/airless)
...
APPLY_AIRLESS_ATMOS(/turf/open/floor/mineral/plastitanium/airless)

/turf/open/floor/mineral/plastitanium/red
	icon_state = "plastitanium_red"
	floor_tile = /obj/item/stack/tile/mineral/plastitanium/red

APPLY_AIRLESS_ATMOS(/turf/open/floor/mineral/plastitanium/red/airless)
...
APPLY_AIRLESS_ATMOS(/turf/open/floor/mineral/bananium/airless)
