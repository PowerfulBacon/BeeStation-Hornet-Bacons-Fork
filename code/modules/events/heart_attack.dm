...
/datum/round_event/heart_attack/start()
	...
	for(var/mob/living/carbon/human/H in shuffle(GLOB.player_list))
		if(!H.client || H.is_dead() || H.InCritical() || !H.can_heartattack() || H.body.has_status_effect(STATUS_EFFECT_EXERCISED) || (/datum/disease/heart_failure in H.diseases) || H.undergoing_cardiac_arrest())
			continue
