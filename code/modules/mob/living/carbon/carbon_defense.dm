...
/mob/living/carbon/attacked_by(obj/item/I, mob/living/user)
	...
	if(I.force)
		add_bodypart_injury(affecting, I.injurytype, I.force, I.damage_severity, I.armour_penetration)
		if(ispath(I.injurytype, /datum/injury/brute) && (IS_ORGANIC_LIMB(affecting)))
