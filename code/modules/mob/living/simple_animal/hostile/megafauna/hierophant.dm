...
/obj/effect/temp_visual/hierophant/blast/proc/do_damage(turf/T)
	...
	for(var/mob/living/L in T.contents - hit_things) //find and damage mobs...
		...
		var/zone = L.get_bodypart(pick(BODY_ZONE_HEAD, BODY_ZONE_CHEST, BODY_ZONE_R_ARM, BODY_ZONE_L_ARM, BODY_ZONE_R_LEG, BODY_ZONE_L_LEG))
		L.add_bodypart_injury(zone, /datum/injury/burn, damage, INJURY_SEVERITY_MINOR, 30)
		if(ishostile(L))
