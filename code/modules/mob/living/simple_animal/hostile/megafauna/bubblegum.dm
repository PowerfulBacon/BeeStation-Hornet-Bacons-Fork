...
/mob/living/simple_animal/hostile/megafauna/bubblegum/proc/bloodsmack(turf/T, handedness)
	...
	for(var/mob/living/L in T)
		if(!faction_check_mob(L))
			...
			L.apply_damage_randomly(10, BLUNT, src)
	SLEEP_CHECK_DEATH(3)
...
/mob/living/simple_animal/hostile/megafauna/bubblegum/Bump(atom/A)
	if(charging)
		...
		if(isliving(A))
			...
			L.apply_damage(istype(src, /mob/living/simple_animal/hostile/megafauna/bubblegum/hallucination) ? 15 : 30, BODY_ZONE_CHEST, CRUSH)
