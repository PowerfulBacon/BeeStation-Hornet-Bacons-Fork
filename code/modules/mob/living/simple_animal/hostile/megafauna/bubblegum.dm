...
/mob/living/simple_animal/hostile/megafauna/bubblegum/AttackingTarget(mob/living/clicked_on)
	if(!charging)
		. = ..()
		if(.)
...
/mob/living/simple_animal/hostile/megafauna/bubblegum/hallucination/AttackingTarget(mob/living/clicked_on)
	return
