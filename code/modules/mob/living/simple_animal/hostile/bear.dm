...
/mob/living/simple_animal/hostile/bear/butter/AttackingTarget(mob/living/clicked_on) //Makes some attacks by the butter bear slip those who dare cross its path.
	if(isliving(target))
