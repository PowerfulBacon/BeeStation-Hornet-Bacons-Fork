...
/mob/living/simple_animal/hostile/retaliate/poison/AttackingTarget(mob/living/clicked_on)
	. = ..()
	if(. && isliving(target))
...
/mob/living/simple_animal/hostile/retaliate/poison/snake/AttackingTarget(mob/living/clicked_on)
