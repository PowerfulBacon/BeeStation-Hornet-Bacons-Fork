...
/obj/item/assembly/voice/Hear(message, atom/movable/speaker, datum/chatmessage/message_image, message_language, raw_message, radio_freq, list/spans, list/message_mods = list())
	. = ..()
	if(speaker == src)
		return
