...
/datum/skill/coordination/update_effect(mob/living/owner)
	ADD_MULTIPLICATIVE_TRAIT(owner, TRAIT_WEAPON_INACCURACY, SOURCE_STATS, linear_range(2, 0.5))
	ADD_CUMULATIVE_TRAIT(owner, TRAIT_WEAPON_INACCURACY, SOURCE_STATS, linear_range(20, 0))
