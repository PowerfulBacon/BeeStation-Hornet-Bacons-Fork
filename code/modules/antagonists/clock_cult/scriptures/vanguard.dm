...
/datum/clockcult/scripture/slab/vanguard/invoke_success()
	...
	ADD_MULTIPLICATIVE_TRAIT(invoker, TRAIT_DAMAGE_SLOWDOWN_MULTIPLIER, VANGUARD_TRAIT, 0)
...
/datum/clockcult/scripture/slab/vanguard/end_invoke()
	...
	REMOVE_TRAIT(invoker, TRAIT_DAMAGE_SLOWDOWN_MULTIPLIER, VANGUARD_TRAIT)
