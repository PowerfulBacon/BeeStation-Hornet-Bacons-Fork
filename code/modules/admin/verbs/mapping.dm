...
/client/proc/enable_debug_verbs()
	...
	add_verb(/client/proc/disable_debug_verbs)
	add_verb(GLOB.admin_verbs_debug_mapping)
...
/client/proc/disable_debug_verbs()
	...
	remove_verb(/client/proc/disable_debug_verbs)
	remove_verb(GLOB.admin_verbs_debug_mapping)
