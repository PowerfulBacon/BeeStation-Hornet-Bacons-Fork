/client/proc/map_template_load()
	...
	if(alert(src,"Confirm location.","Template Confirm","Yes","No") == "Yes")
		var/datum/task/map_generator/template_placer = template.load(T, centered = TRUE)
		template_placer.continue_with(CALLBACK(src, PROC_REF(after_map_load), template.name, T))
	images -= preview

/client/proc/after_map_load(template_name, T, datum/task/map_generator/map_generator)
