...
/obj/item/kinetic_crusher/attack(mob/living/target, mob/living/carbon/user)
	if(!ISWIELDED(src))
		...
		return
	var/datum/status_effect/crusher_damage/C = target.body.has_status_effect(STATUS_EFFECT_CRUSHERDAMAGETRACKING)
	if(!C)
		C = target.body.apply_status_effect(STATUS_EFFECT_CRUSHERDAMAGETRACKING)
...
/obj/item/kinetic_crusher/afterattack(atom/target, mob/living/user, proximity_flag, clickparams)
	...
	if(proximity_flag && isliving(target))
		...
		var/datum/status_effect/crusher_mark/CM = L.body.has_status_effect(STATUS_EFFECT_CRUSHERMARK)
		if(!CM || CM.hammer_synced != src || !L.body.remove_status_effect(STATUS_EFFECT_CRUSHERMARK))
			return
		var/datum/status_effect/crusher_damage/C = L.body.has_status_effect(STATUS_EFFECT_CRUSHERDAMAGETRACKING)
		if(!C)
			C = L.body.apply_status_effect(STATUS_EFFECT_CRUSHERDAMAGETRACKING)
...
/obj/item/projectile/destabilizer/on_hit(atom/target, blocked = FALSE)
	if(isliving(target))
		var/mob/living/L = target
		var/had_effect = (L.body.has_status_effect(STATUS_EFFECT_CRUSHERMARK)) //used as a boolean
		var/datum/status_effect/crusher_mark/CM = L.body.apply_status_effect(STATUS_EFFECT_CRUSHERMARK, hammer_synced)
		if(hammer_synced)
...
/obj/item/crusher_trophy/miner_eye/on_mark_detonation(mob/living/target, mob/living/user)
	user.body.apply_status_effect(STATUS_EFFECT_BLOODDRUNK)
