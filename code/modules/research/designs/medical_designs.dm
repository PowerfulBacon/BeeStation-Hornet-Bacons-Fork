...
/datum/design/mmi
	...
	category = list("Control Interfaces", CATEGORY_MEDICAL)
...
/datum/design/cyberimp_welding
	...
	category = list("Implants", CATEGORY_MEDICAL)
	departmental_flags = DEPARTMENTAL_FLAG_MEDICAL
...
/datum/design/cyberimp_linkedsurgery
	...
	category = list("Implants", CATEGORY_MEDICAL, CATEGORY_BLUESPACE)
...
/datum/design/cyberimp_hydraulic_blade
	...
	category = list("Cybernetics", CATEGORY_MEDICAL)
	departmental_flags = DEPARTMENTAL_FLAG_MEDICAL
