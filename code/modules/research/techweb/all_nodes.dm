...
/datum/techweb_node/adv_weaponry
	...
	design_ids = list("pin_loyalty", "hardsuit_eng", "hardsuit_sec", "hardsuit_exp", "hardsuit_ert", "hardsuit_syn", "hardsuit_elite", "egun", "combat_shotgun", "esword", "pulse", "mosin", "firingping")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 10000)
	export_price = 5000
