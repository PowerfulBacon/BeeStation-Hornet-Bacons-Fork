...
/datum/dmscript/compiler_operation/assignation
	...
	priority = PRECEDENCE_ASSIGNMENT

/datum/dmscript/compiler_operation/assignation/process_operation(text_line, list/subparts)
	...
	return "[BYTECODE_ASSIGN] [left_group_identifier] [right_group_identifier]"
