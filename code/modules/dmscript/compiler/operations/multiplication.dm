...
/datum/dmscript/compiler_operation/multiplication
...
/datum/dmscript/compiler_operation/multiplication/process_operation(text_line, list/subparts)
	...
	return "[BYTECODE_MULTIPLY] [left_group_identifier] [right_group_identifier]"
