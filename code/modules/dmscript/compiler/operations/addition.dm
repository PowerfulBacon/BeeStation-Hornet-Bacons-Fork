...
/datum/dmscript/compiler_operation/addition
...
/datum/dmscript/compiler_operation/addition/process_operation(text_line, list/subparts)
	...
	return "[BYTECODE_ADD] [left_group_identifier] [right_group_identifier]"
