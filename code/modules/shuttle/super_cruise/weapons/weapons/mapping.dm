...
/obj/effect/landmark/exploration_weapon_spawner
	...
	icon_state = "blue_up"
	var/ship_strength = 10
	var/spawn_dir = 2	//Where the weapon itself will spawn, direction will be the direction it faces

/obj/effect/landmark/exploration_weapon_spawner/medium
	ship_strength = 30

/obj/effect/landmark/exploration_weapon_spawner/strong
	ship_strength = 60

/obj/effect/landmark/exploration_weapon_spawner/legendary
	ship_strength = 90

/obj/effect/landmark/exploration_weapon_spawner/Initialize()
	. = ..()
	do_weapon_spawn(ship_strength)
