...
//Quick lighting:
//Has no shadows and instantly updates.
//Used for objects that have small light radiuses.
//The light has no shadows and is visible if the source is visible.
#define QUICK_LIGHTING 0
//Fancy lighting:
//Has shadows, also updates instantly.
//Used for objects that have largeer light radius.
...
#define FLASH_LIGHT_POWER MAXIMUM_INTENSITY
