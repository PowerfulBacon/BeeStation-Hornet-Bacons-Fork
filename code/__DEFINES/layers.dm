...
#define NORMAL_LIGHTING_PLANE 17
#define NORMAL_LIGHTING_LAYER 17
#define NORMAL_LIGHTING_RENDER_TARGET "*NORMAL_PLANE"

#define NORMAL_POINT_MAP_PLANE 18
#define NORMAL_POINT_MAP_LAYER 18
#define NORMAL_POINT_MAP_RENDER_TARGET "*NORMAL_COMBINATION_PLANE"

#define O_LIGHTING_VISUAL_PLANE 19
#define O_LIGHTING_VISUAL_LAYER 19
...
#define BALLOON_CHAT_PLANE 23.5

//HUD layer defines

#define FULLSCREEN_PLANE 24
#define FLASH_LAYER (FULLSCREEN_PLANE)
#define FULLSCREEN_LAYER (FULLSCREEN_PLANE + 0.1)
#define UI_DAMAGE_LAYER (FULLSCREEN_PLANE + 0.2)
#define BLIND_LAYER (FULLSCREEN_PLANE + 0.3)
#define CRIT_LAYER (FULLSCREEN_PLANE + 0.4)
#define CURSE_LAYER (FULLSCREEN_PLANE + 0.5)
