...
//If you add a new status, be sure to add a list for it to the brain_ais thing or whatever I called it global in _globalvars/lists/mobs.dm
#define AI_ON		1
#define AI_IDLE		2
#define AI_OFF		3
#define AI_Z_OFF	4
...
#define SLEEP_CHECK_DEATH(X) sleep(X); if(QDELETED(src) || body.stat == DEAD) return;
