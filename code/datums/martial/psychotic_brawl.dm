...
/datum/martial_art/psychotic_brawling/proc/psycho_attack(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	switch(rand(1,8))
		...
		if(4)
			...
			A.add_bodypart_injury(BODY_ZONE_HEAD, A.dna.species.attack_type, rand(5,10), INJURY_SEVERITY_MINOR, 10)
			D.add_bodypart_injury(BODY_ZONE_HEAD, A.dna.species.attack_type, rand(5,10), INJURY_SEVERITY_MINOR, 10)
		...
		if(5,6)
			...
			D.add_bodypart_injury(A.zone_selected, A.dna.species.attack_type, rand(15,30), INJURY_SEVERITY_MINOR, 20)
