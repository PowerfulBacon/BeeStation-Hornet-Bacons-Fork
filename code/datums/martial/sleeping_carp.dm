...
/datum/martial_art/the_sleeping_carp/proc/wristWrench(mob/living/carbon/human/A, mob/living/carbon/human/D)
	if(!D.stat && !D.IsStun() && !D.IsParalyzed())
		...
		D.apply_damage(5, pick(BODY_ZONE_L_ARM, BODY_ZONE_R_ARM), BLUNT, A.body.get_active_hand())
		D.Stun(60)
		return 1
...
/datum/martial_art/the_sleeping_carp/proc/headKick(mob/living/carbon/human/A, mob/living/carbon/human/D)
	if(!D.stat && !D.IsParalyzed())
		...
		var/obj/item/bodypart/leg/leg = A.body.get_random_leg()
		D.apply_damage(20, BODY_ZONE_HEAD, BLUNT, leg)
...
/datum/martial_art/the_sleeping_carp/proc/elbowDrop(mob/living/carbon/human/A, mob/living/carbon/human/D)
	if(!(D.mobility_flags & MOBILITY_STAND))
		...
		if(D.stat)
			D.death() //FINISH HIM!
		D.apply_damage(50, BODY_ZONE_CHEST, BLUNT, A.body.get_active_hand())
...
/datum/martial_art/the_sleeping_carp/harm_act(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	D.apply_damage(9 + arm.punch_damage, BODY_ZONE_CHEST, arm.punch_damage_type, arm)
