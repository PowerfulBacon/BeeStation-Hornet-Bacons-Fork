...
/datum/task/map_generator/map_place
...
/datum/task/map_generator/map_place/New(datum/parsed_map/placing_template, x_offset = 1, y_offset = 1, z_offset = world.maxz + 1, cropMap = FALSE, no_changeturf = FALSE, x_lower = -INFINITY, x_upper = INFINITY, y_lower = -INFINITY, y_upper = INFINITY, placeOnTop = FALSE)
	. = ..()
...
/datum/task/map_generator/map_place/execute_run()
	..()
...
/datum/task/map_generator/map_place/proc/set_stage(stage)
	run_stage = 1
	current_run = stage

/datum/task/map_generator/map_place/get_name()
...
/datum/task/map_generator/map_place/proc/build_coordinates_start()
...
/datum/task/map_generator/map_place/proc/build_coordinates()
	while (TRUE)
...
/datum/task/map_generator/map_place/proc/build_coordinate_grid_line()
...
/datum/task/map_generator/map_place/proc/build_cache_start()
...
/// Build the cache
/datum/task/map_generator/map_place/proc/build_cache()
	do
		// dpos loop
		while (dpos != 0)
...
/datum/task/map_generator/map_place/proc/build_cache_move_next()
	run_stage ++
...
/datum/task/map_generator/map_place/proc/build_cache_set_model_loop()
...
/datum/task/map_generator/map_place/proc/build_cache_construct_members()
