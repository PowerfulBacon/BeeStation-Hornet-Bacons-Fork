...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_DAMAGE_SLOWDOWN_MULTIPLIER" = TRAIT_DAMAGE_SLOWDOWN_MULTIPLIER,
		"TRAIT_ITEM_SLOWDOWN_MULTIPLIER" = TRAIT_ITEM_SLOWDOWN_MULTIPLIER,
	...
	/mob/living/carbon = list(
		...
		"TRAIT_PUNCH_DAMAGE" = TRAIT_PUNCH_DAMAGE,
		"TRAIT_WEAPON_INACCURACY" = TRAIT_WEAPON_INACCURACY,
		"TRAIT_BLEED_RESISTANCE" = TRAIT_BLEED_RESISTANCE,
	),
