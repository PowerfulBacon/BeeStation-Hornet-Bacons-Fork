      ...
      <Stack.Item>
        ...
        {tab === 2 && (
          <Box>
            ...
            <br />
            <p>
              A potent spell that will stun and mute victims upon contact. Simple, clean, and quite effective for a plethora of
              situations.
            </p>
            <p>
              Paralyzes for for 16 seconds, mutes for 12 seconds and cult-slurs speech for 30 seconds (from the stun moment). If
              used on a cyborg it stuns it as if hit by a heavy EMP.
            </p>
            <p>
              <b>Does not work on mindshielded personnel!</b>
            </p>
            <p>
              While slurring cult-speak, victims will speak in a disturbing, incomprehensible way. This is usually a dead
              giveaway that a Cult is onboard when shouted over the radio (unless the Bartender has been handing out way too
              many Nar&apos;Sours).
            </p>
          </Box>
        )}
        {tab === 3 && (
          <Box>
            ...
            <b>Name</b>: Teleport
            <b>Charges</b>: 1<p>Instantly teleports yourself, someone, or something to a scribed teleport rune.</p>
          </Box>
        )}
        {tab === 4 && (
          <Box>
            ...
            <b>Charges</b>: 1
            <p>
              A large spell that allows a user to channel dark energy into an EMP, causing all electronics in the area to
              malfunction or be disabled.
            </p>
          </Box>
        )}
        {tab === 5 && (
          <Box>
            ...
            <b>Charges</b>: 4
            <p>
              A stealthy spell that will summon shadowy handcuffs on a person, and temporarily silence your victim for 10
              seconds. Used for keeping crew restrained until they can be converted. The restraints will diseappear if the
              victim is converted.
            </p>
          </Box>
        )}
        {tab === 6 && (
          <Box>
            ...
            <b>Charges</b>: 1
            <p>
              Converts plasteel into runed metal, 50 iron into a construct shell, living cyborgs and AIs into constructs (after
              a delay), cyborg shells into construct shells, and airlocks into brittle runed airlocks (after a delay, on harm
              intent)
            </p>
          </Box>
        )}
        {tab === 7 && (
          <Box>
            ...
            <b>Charges</b>: 1
            <p>
              When used on a cultist (including yourself), otherworldly armor, including a cult blade and bola, will appear on
              them.
            </p>
          </Box>
        )}
        {tab === 8 && (
          <Box>
            ...
            <b>Charges</b>: 1
            <p>
              Enables you to summon a ritual dagger used to draw runes, in case you lost yours or forgot to pick it up from the
              floor when you got converted. Activate the spell and then click yourself.
            </p>
          </Box>
        )}
        {tab === 9 && (
          <Box>
            ...
            <b>Charges</b>: 4
            <p>
              Silently curses someone&apos;s mind with living nightmares, causing them to hallucinate. Can be used at a range,
        ...
        {tab === 10 && (
          <Box>
            ...
            <b>Charges</b>: 10
            <p>
              A multi-function spell that alternates between hiding and revealing nearby runes and cult structures within a
              range of <b>5 tiles</b>. You can still teleport to concealed teleport runes and prepare blood magic on concealed
              empower runes.
            </p>
            <p>Will make runed airlocks look like basic maintenance airlocks, but only cultists will have access.</p>
          </Box>
        )}
        {tab === 11 && (
          <Box>
            ...
            <b>Charges</b>: 5
            <p>
              A complex type of blood magic, capable of healing cultists, summoning a spear, firing powerful bolts of blood, or
              manifesting a huge beam to convert walls and floors into those of Nar&apos;sie.
            </p>
            <p>
              Blood Rites is fueled by blood - use the hand on the floor (or living victims) in order to absorb blood off the
              floor to fuel the rites.
            </p>
          </Box>
        )}
      </Stack.Item>
      ...
      <Stack.Item>
        {tab === 1 && (
          <Box>
            ...
            <b>Name</b>: Offer
            <br />
            <b>Cultists Required</b>: 1 (sacrificing dead non-target), 2 (conversion), 3 (sacrificing target or non-dead person)
            <p>
              Instantly converts a normal crewmember on top of it to the cult, healing them for 75% of their brute and burn
              damage, and spawning a ritual dagger.
            </p>
            <p>
              Mindshield-implanted crew cannot be converted, only sacrificed, (but constructs are no less dangerous than humans)
              -{' '}
              <b>
                therefore it is recommended that you quickly finish off security victims before their radio or suit sensors can
                give you away!
              </b>
            </p>
            <p>
              Sacrifice victims will be gibbed and have their soul placed into a Soul Stone, which can then be placed into a
              construct shell.
            </p>
          </Box>
        )}
        {tab === 2 && (
          <Box>
            ...
            <p>
              Allows cultists to prepare greater amounts of blood magic at far less of a cost. While standing on an empowering
              rune, the spell count is capped at 4 instead of 1.
            </p>
            <p>
              Additionally, preparing blood magic takes far less time, and you don&apos;t lose as much blood while doing it.
            </p>
          </Box>
        )}
        {tab === 3 && (
          ...
          <Box>
            <h2>
              <Box inline textColor="#C80000">
                <i>Pasnar val&apos;keriam usinar. Savrae ines amutan. Yam&apos;toth remium il&apos;tarat!</i>
              </Box>
            </h2>
            <b>Name</b>: Revive
            <br />
            <b>Cultists Required</b>: 1
            <p>
              Whenever someone is sacrificed on a Convert rune, they add one (global) charge to this rune. Placing a cultist
              corpse on the rune and activating it will bring them back to life, expending a hefty three charges in the process.
              It starts with one freebie revival, so use it sparingly.
            </p>
            <p>
              Catatonic(disconnected/ghosted) cultists can be reawakened with a new soul by putting them on the Revive rune and
              activating it. This method of revival does not consume any charges.
            </p>
          </Box>
        )}
        {tab === 5 && (
          <Box>
            ...
            <br />
            <b>Cultists Required</b>: 1
            <p>When invoked, makes a 5-minute invisible wall to block passage. Can be invoked again to reverse this.</p>
            <p>
              Invoking one barrier rune will chain activate other barrier runes that are within 2 tiles from one another.
              Reversing a barrier rune will not chain deactivate other barrier runes.
            </p>
            <p>
              Costs 2 brute both to invoke and to deactivate (regardless how many are chained). Active barrier runes have a
              subtle wriggling animation, and are usually brighter.
            </p>
          </Box>
        )}
        {tab === 6 && (
          <Box>
            ...
            <p>Does not work on restrained cultists who are buckled or being pulled.</p>
          </Box>
        )}
        {tab === 7 && (
          <Box>
        ...
        {tab === 8 && (
          <Box>
            ...
            <br />
            <b>Cultists Required</b>: 1<p>This rune gives you two powerful options:</p>
            <p>
              <b>1)</b> To manifest ghosts as semitransparent homunculi, which are effectively weak, humanoid cultists with no
              self preservation instinct. To sustain these homunculi, you must remain on the rune, and each homunculi you have
            ...
            <p>
              <b>2)</b> To ascend as a dark spirit. This option costs no health to use and will give you virtually unlimited
              knowledge! You can use information given to you by ghosts in this form, commune with the cult with your booming
              voice, and even mark a target that will be &quot;pinpointed&quot; for the rest of the cult. You can even use this
              function after manifesting ghosts to help guide them in combat - manifested ghosts can also see regular ghosts and
        ...
        {tab === 9 && (
          <Box>
            ...
            <b>Cultists Required</b>: 3
            <p>
              A harbinger of the end times. It scales depending on the crew&apos;s strength relative to the cult. Effects
              include a massive EMP, unique hallucination for non-cultists, and if the cult is doing poorly, certain events. The
              rune can only occur in the Nar-Sie ritual sites and will prevent Nar-Sie from being summoned there in the future.
            </p>
            <p>
              Similarly to the Ritual of Dimensional Rending, the Apocalypse rune can only be scribed in one of the 3 ritual
              areas. After the Apocalypse rune has been scribed, that particular ritual area can no longer be used to summon
              Nar-Sie.
            </p>
          </Box>
        )}
        {tab === 10 && (
          <Box>
            ...
            <p>
              This rune tears apart dimensional barriers, calling forth the Geometer. It needs a free 3x3 space, and can only be
              summoned in 3 areas around the station. To start drawing it the requested target must have already been
              sacrificed. Starting to draw this rune creates a weak forcefield around the caster and alarms the entire station
              of its location. The caster must be defended for 45 seconds before it&apos;s complete.
            </p>
            <p>
              After it&apos;s drawn, 9 cultists, constructs, or summoned ghosts must stand on the rune, which can then be
              invoked to manifest Nar&apos;Sie herself.
            </p>
          </Box>
        )}
      </Stack.Item>
